  ...
  return (
    <div className="app">
      <header className="header-wrapper">
        <div>
        <h1><span class="brand_names" style="color: #FFDF00;
    font-size: 36px;
    font-weight: bold;">+</span>Plus | <span class="brand_names" style="
    color: #10E000;
    font-size: 29px;
    font-weight: 300;
">Your Logo </span></h1>
        ...
        <div>
          <span className="scheme-name">Terms & Conditions </span>
          {/* <Link className="visit-link" to="https://google.com" target='_blank'>
            Visit xyz website
          </Link> */}
          <a className='visit-link' href='#'  rel='noreferrer' style="font-family: var(--font-primary);
    font-weight: 500;
    font-size: 15px;
    letter-spacing: 1px;
    ...
    text-decoration: none;">Help & Support</a>
        </div>
      </header>
      <CardGrid data={data} />
    </div>
